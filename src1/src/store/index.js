...
export const store = configureStore({
    ...
    middleware: (getDefaultMiddleware) =>
        getDefaultMiddleware().concat(authApi.middleware, userApi.middleware, statisticApi.middleware, studentApi.middleware, subjectApi.middleware, groupApi.middleware, teacherSubjectApi.middleware, teacherGroupApi.middleware, paymentApi.middleware, groupScheduleApi.middleware, attendanceApi.middleware, gradesApi.middleware),
});
